<section
    x-data="{
        editing: false,
        savedName: @js(old('name', $user->name)),
        savedEmail: @js(old('email', $user->email)),
    }">
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6"
        ...
        <div class="flex items-center gap-3">
            ...
            <div class="flex items-center gap-3" x-show="editing" x-cloak>
                ...
                <x-secondary-button type="button" x-on:click="editing = false; $refs.nameInput.value = savedName; $refs.emailInput.value = savedEmail">{{ __('Cancel') }}</x-secondary-button>
            </div>
