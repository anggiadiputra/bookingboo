...
**File Dokumen:** `docs/uihalodoc.md`  
...
1. **Pasien / Keluarga & Caregiver (Mobile-First ala Halodoc):**
   ...
   * Jika dibuka pada layar desktop/PC, tampilan tetap elegan dan terpusat di tengah (*centered mobile-shell container*).
...
* **Struktur Komponen:**
  1. **Top Location & Notification Bar:**
     * Pemilih lokasi: `📍 Lokasi Anda: [Jakarta Selatan / Auto Detect] ▾`
     * Ikon Lonceng Notifikasi di kanan atas.
  2. **Pill Search Bar:**
     * Kolom pencarian rounded dengan ikon kaca pembesar dan placeholder *"Cari caregiver, pendamping RS, rawat lansia..."*.
  ...
  6. **Bottom Navigation Bar (5 Tab Mobile):**
     * 🏠 Beranda | 📋 Riwayat | 💬 Chat | 🚨 Darurat | 👤 Profil
